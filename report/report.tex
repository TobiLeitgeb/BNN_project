...
\end{figure}
Again a network with 2 hidden layers with 20 neurons is used, as well as the same 20 training points. The solution term $u$ and the forcing term $f$ can both, after the training stage, be predicted. The plots for the B-PINN can be seen in \ref{fig:BPINNpred}.
\begin{figure}[htbp!]
    \centering
